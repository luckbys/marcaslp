  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="fixed top-0 left-0 right-0 bg-white shadow-md z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-2">
            ...
            {/* Botão de Telefone */}
            <button className="bg-yellow-500 hover:bg-yellow-400 text-gray-800 font-bold py-2 px-4 rounded-lg flex items-center gap-2 text-sm transition-all highlight-hover btn-press group relative overflow-hidden">
      ...
      >
        ...
        {/* Marca d'água R */}
        <div className="hero-watermark right-1/4 top-1/2 transform -translate-y-1/2">
          ®
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="text-sm space-y-2">
                <li>contato@legadomarcas.com.br</li>
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-sm">
              © 2024 Legado Marcas. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </footer>
